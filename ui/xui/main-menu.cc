...
void MainMenuGeneralView::Draw()
{
    ...
    snprintf(buf, sizeof(buf), "Clock Speed %d%% (%.2f MHz)",
             (int)(g_config.perf.cpu_clockspeed_scale * 100),
             (733333333 * g_config.perf.cpu_clockspeed_scale) / 1000000);
    Slider("Virtual CPU clock", &g_config.perf.cpu_clockspeed_scale, buf, 0.01f,
           2.f, 0.01f);
